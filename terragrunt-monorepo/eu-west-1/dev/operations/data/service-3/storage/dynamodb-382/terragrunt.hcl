...
dependencies {
  paths = [
    "../../../../../../../../eu-west-1/qa/finance/application/service-3/monitoring/log-aggregation-188",
...
terraform {
  source = "git::git@github.com/example/terraform-modules.git//dynamodb-382?ref=v1.0.0"
}
