...
dependencies {
  paths = [
    ...
    "../../../../../../../../eu-west-1/qa/operations/platform/service-3/compute/auto-scaling-254",
...
terraform {
  source = "git::git@github.com/example/terraform-modules.git//certificates-495?ref=v1.0.0"
}
