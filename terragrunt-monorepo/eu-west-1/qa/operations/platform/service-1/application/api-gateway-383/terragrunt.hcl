...
dependencies {
  paths = [
    ...
    "../../../../../../../../us-west-2/qa/marketing/data/service-2/monitoring/trace-collection-517",
    "../../../../../../../../us-west-2/dev/marketing/platform/service-2/application/event-bus-37",
  ]
}

terraform {
  source = "git::git@github.com/example/terraform-modules.git//api-gateway-383?ref=v1.0.0"
}
