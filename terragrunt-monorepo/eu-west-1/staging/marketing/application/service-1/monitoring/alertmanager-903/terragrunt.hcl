...
dependencies {
  paths = [
    ...
    "../../../../../../../../eu-west-1/staging/finance/application/service-2/security/waf-743",
...
terraform {
  source = "git::git@github.com/example/terraform-modules.git//alertmanager-903?ref=v1.0.0"
}
