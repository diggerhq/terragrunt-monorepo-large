...
dependencies {
  paths = [
    ...
    "../../../../../../../../us-east-1/qa/marketing/application/service-2/storage/rds-293",
...
terraform {
  source = "git::git@github.com/example/terraform-modules.git//direct-connect-670?ref=v1.0.0"
}
