...
dependencies {
  paths = [
    ...
    "../../../../../../../../eu-west-1/qa/marketing/platform/service-3/compute/fargate-964",
    "../../../../../../../../us-east-1/qa/operations/application/service-1/storage/fsx-399",
  ]
}

terraform {
  source = "git::git@github.com/example/terraform-modules.git//auto-scaling-598?ref=v1.0.0"
}
