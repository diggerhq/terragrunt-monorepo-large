...
dependencies {
  paths = [
    ...
    "../../../../../../../../us-east-1/dev/finance/application/service-3/security/secrets-737",
...
terraform {
  source = "git::git@github.com/example/terraform-modules.git//elasticache-229?ref=v1.0.0"
}
