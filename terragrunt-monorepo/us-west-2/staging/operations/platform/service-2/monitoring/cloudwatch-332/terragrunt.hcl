...
dependencies {
  paths = [
    ...
    "../../../../../../../../us-east-1/staging/marketing/platform/service-1/monitoring/cloudwatch-825",
    "../../../../../../../../eu-west-1/staging/operations/data/service-3/compute/ecs-401",
  ]
}

terraform {
  source = "git::git@github.com/example/terraform-modules.git//cloudwatch-332?ref=v1.0.0"
}
