...
dependencies {
  paths = [
    ...
    "../../../../../../../../us-east-1/dev/finance/platform/service-2/security/waf-36",
    "../../../../../../../../us-east-1/qa/marketing/data/service-1/storage/rds-643",
  ]
}

terraform {
  source = "git::git@github.com/example/terraform-modules.git//log-aggregation-653?ref=v1.0.0"
}
